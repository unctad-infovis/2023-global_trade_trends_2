...
function LineChart({
  allow_decimals = true, data, idx, line_width = 5, note = '', show_first_label = true, source, subtitle = false, suffix = '', title
}) {
  ...
  const createChart = useCallback(() => {
    Highcharts.chart(`chartIdx${idx}`, {
      caption: {
        ...
        text: `<em>Source:</em> ${source} <br /><em>Note:</em> <span>${note} Figures for Q1 2023 are estimates. Q2 2023 is a <a href="https://unctadstat.unctad.org/en/Nowcasts.html">nowcast</a>.</span>`,
      ...
      chart: {
        events: {
          load() {
            ...
            this.renderer.image('https://storage.unctad.org/2023-global_trade_trends_2/assets/img/unctad_logo.svg', 20, 15, 80, 100).add();
          }
        },
        marginLeft: 70,
        height: chartHeight,
